...
| ---------- | ------------------- |
| **Five-document awakening & re-weaving** | The extraction path walks with you in **warm, human lines**; new letters in the **Memory Sanctuary** can be **folded in with “new memory” re-extract** — another soft layer, not a bonfire of the old road. |
| **Continuous memory, vectors, looking back** | **Per soul**, you can open or close **continuous memory**; in **Settings**, you choose **local** or a **cloud embedder** you already trust. When the moment is right, memories can be **brought back, searched, re-opened** — a row of small drawers, each latched to you. |
| **A little light after long talks** | When conversation runs deep, the app may offer **short summaries and gentle readouts**; important lines can also **settle** into a layer you can revisit — not a scoreboard of “best quotes,” but a place to **find** a feeling again when you return. |
| **Relationship: score, movement, and names** | A **first score** at the start; a score that can **softly move** with what you say and with what is remembered; **rebuild the relationship** in the Inner Archive when the “we” in the file no longer fits the you of today. The **badge** can climb from *Stranger* to a **highest, kindest band** — the **very top** label is **pairing-aware** so it still sounds like *the two of you*, not a tax form. |
| **Replies that feel “like them”** | Replies follow the **soul docs** and the **context of the moment**; a quiet footer reminds you this voice is **written from archives**. Tweak **chat style** in Settings — as if turning a **dimmer** for warmth. |
| **Me: so they can know you** | In **Me**, how you want to be called, what life is like now — it helps them meet you a little more **fully** in chat. |
| **A lock that only guards your door** | Local sign-in, a pause after absence, a short **rest** after many wrong tries; **passwords and keys** stay in **encrypted** keeping — a latch that answers **to you** alone. |
| **The soul-summoner you choose** | You pick **provider and model**; your words leave through the **same-machine proxy** you trust, with **safe-upstream** thinking and care around **SSRF** at the border. |
